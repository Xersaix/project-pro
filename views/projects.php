...
<ul class="nav nav-underline col-md-12 text-center">
    <li class="nav-item">
        <a class="nav-link text-white" href="#kitchens" data-target="kitchens">Cuisines</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white" href="#bathrooms" data-target="bathrooms">Salles de bains</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white" href="#bedrooms" data-target="bedrooms">Chambres</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white" href="#living-rooms" data-target="living-rooms">Salons</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white" href="#carpentries" data-target="carpentries">Menuiseries</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white" href="#Couloirs" data-target="hallways">Couloirs</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white" href="#lighting" data-target="lighting">Eclairages</a>
    </li>
</ul>
