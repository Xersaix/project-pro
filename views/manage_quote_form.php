...
<?php for ($i=0; $i < count($quotes); $i++) { ?>
  ...
  <a type="button" href="controller_update_form.php?id=<?=$quotes[$i]["quote_id"]?>" class="btn btn-primary">Modifier</a>
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <button class="btn btn-primary" onclick="Fancybox.close()">Annulé</button></span>
  </div>
</div>
</div>
